        ...
        <View style={styles.modalContent}>
          ...
          {selectedOrder && (
            <View style={styles.modalBody}>
              ...
              {/* Test button for debugging price updates */}
              <TouchableOpacity
                ...
                onPress={() => {
                  if (editedItems.length > 0) {
                    ...
                    console.log('Test button: updating price for item', testItem.id, 'to', testPrice);
                    handleUpdatePrice(testItem.id, testPrice);
                    
                    // Log the updated item after state update
                    setTimeout(() => {
                      const updatedItem = editedItems.find(item => item.id === testItem.id);
                      console.log('Test button: item after price update:', updatedItem);
                    }, 100);
                  }
                }}
              >
                <Text style={styles.testButtonText}>Test Price Update</Text>
              </TouchableOpacity>
            </View>
          )}
        </View>
