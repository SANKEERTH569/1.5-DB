...
export default function ProfileScreen() {
  ...
  const handleOpenMap = () => {
    Linking.openURL(USER_DATA.addressLink);
  };

  const handleWhatsApp = () => {
    const phoneNumber = USER_DATA.phone.replace(/\s+/g, '');
  ...
  const handleEmail = () => {
    Linking.openURL(`mailto:${USER_DATA.email}`);
  };
      ...
      <View style={styles.header}>
        ...
        <View style={styles.profileHeader}>
          ...
          <View style={styles.membershipContainer}>
            ...
            <Text style={styles.membershipText}>Member since {USER_DATA.memberSince}</Text>
          </View>
        </View>
        
        <View style={styles.statsContainer}>
          <View style={styles.statItem}>
            <Text style={styles.statValue}>{USER_DATA.orderCount}</Text>
          ...
          <View style={styles.infoCard}>
            ...
            <View style={styles.infoItem}>
              ...
              <View style={styles.infoContent}>
                ...
                <Text style={styles.infoValue} numberOfLines={2}>{USER_DATA.address}</Text>
              </View>
              <TouchableOpacity 
                style={styles.actionButton}
          ...
          >
            <View style={styles.emailCardContent}>
              ...
              <View style={styles.contactTextContainer}>
                ...
                <Text style={styles.emailSubtitle}>{USER_DATA.email}</Text>
              </View>
