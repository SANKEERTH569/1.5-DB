...
const DELIVERIES = [
  ...
  },
  {
    ...
    total: 790,
    completed: false,
    status: 'En Route', // Delivery Status
  },
];
...
export default function DeliveryScreen() {
  ...
  const handleStartDelivery = (delivery: any) => {
    console.log('Passing delivery:', delivery); // Debugging
    router.push({
      pathname: '/(delivery)/delivery-details',
      params: { delivery: JSON.stringify(delivery) },
    });
  };
